...
Research Experience
======
* **Research Intern, [HPC Lab](https://hpc.ipm.ac.ir/) at Institute for Research in Fundamental Sciences ([IPM](http://www.ipm.ac.ir/))**,    *Summer 2021*
  * Supervisor: Professor [Dara Rahmati](https://scholar.google.com/citations?user=xwJgOl0AAAAJ&hl=en)
  * This project aims to setup and relearn the Nvidia GameGAN to new games such as soccer stars to find
feasibility of learning the physics rules by GameGAN. To achieve this goal, learning the details of GameGAN
and finding enhancement opportunities is our priority.
...
Honors and Awards
======
* Placed Top 0.5% in the [Iranian University Entrance Exam](https://en.wikipedia.org/wiki/Iranian_University_Entrance_Exam) (Bachelor's), *August 2017*
* Best Freshman Award in the Amirkabir University of Technology International Collegiate
Programming Contest ([AUT-ICPC](https://icpc.aut.ac.ir/)), *October 2017*
* Ranked 2<sup>nd</sup> in the [Computer Engineering General Skills](http://gs.ce.aut.ac.ir/) Contest at Amirkabir University of Technology,
*July 2020*
* Selected as a Member of the University Team for the National Scientific Olympiad in Computer
...
Skills
======
* **Programming Languages**: Python, Java, Kotlin, C, C++, R, Racket
* **Database Systems**: PPostgreSQL, MySQL, SQLite, MongoDB
* **Web Technologies**: HTML, CSS, JavaScript, AngularJS, React, Spring Boot, Node.js, Express.js
* **Human Languages**: Persian (Native), English (Fluent; TOEFL: 108)
